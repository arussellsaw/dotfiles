...
--awful.util.spawn_with_shell("xrandr --output DVI-I-1 --mode 1920x1080 --right-of HDMI-0 ; xrandr --output HDMI-0 --mode 1920x1080 --left-of DVI-I-1; xrandr --dpi 70")
...
awful.util.spawn_with_shell("compton --config /home/alex/.config/compton.conf")

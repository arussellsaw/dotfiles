...
theme.bg_normal     = "#55585a"
theme.bg_focus      = focus
theme.bg_urgent     = "#dc8cc3"
theme.bg_minimize   = "#b4b4b4"

theme.fg_normal     = text
theme.fg_focus      = ftext
theme.fg_urgent     = text
theme.fg_minimize   = normal
...
-- theme.wallpaper_cmd = { "awsetbg -m 2 /home/alex/Pictures/205714.jpg" }
